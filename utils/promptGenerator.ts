...
export function buildPromptCartaImmersiva(waifu: WaifuLike, fillers: Record<string,string> = {}) {
  ...
  return { titolo:'Carta Immersiva (card-game collezionabile style)', note:'Full-bleed cinematica. Inquadratura dinamica dal basso o diagonale. 1024x1536.', prompt:`${g.parts.identita}, ${g.parts.personalita}, ${g.parts.corpo}, ${g.parts.capelli}, ${g.parts.occhi}, ${g.parts.palette}, dynamic ${posaDinamica}, low angle shot, cinematic composition, full bleed scene, ${outfitDesc}, ${fanservice}, immersive environment: ${g.parts.ambientazione}, atmospheric particles, volumetric light rays, lens flare, depth of field, motion blur on hair and fabric, dramatic lighting, ${g.parts.rarita_detail}, ${g.parts.tecnico}, immersive trading card art, card-game collezionabile immersive style`, negative:g.parts.negative + ', static pose, plain background, simple composition', parametri_consigliati:{ sampler:'DPM++ 2M Karras', steps:40, cfg:8, width:1024, height:1536, hires_fix:true } }
}
