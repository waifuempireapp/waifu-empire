<!-- Loading dell'app.
     - fullscreen → SPLASH a tutta pagina (logo Waifu Empire + carte dell'ultima
       espansione), STATICO come lo spa-loading-template pre-JS → l'handoff tra le
       due fasi e' invisibile (niente flash). Unico movimento: lo spinner in basso.
     - inline → spinner circolare piccolo dentro pannelli/liste. -->
<template>
  <!-- FULLSCREEN: splash con carte (stessa grafica statica del template pre-JS) -->
...
/* ---- FULLSCREEN splash STATICO (identico allo spa-loading-template.html) ---- */
.iw-splash {
