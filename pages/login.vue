  ...
  <div class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="fade-up w-full max-w-md rounded-2xl p-7"
      ...
      <div class="text-center mb-6">
        <img src="~/assets/images/Logo.png" alt="Impero delle Waifu" class="w-80 h-auto mx-auto mb-3" style="mask-image: radial-gradient(ellipse 90% 85% at 50% 50%, black 68%, transparent 92%); -webkit-mask-image: radial-gradient(ellipse 90% 85% at 50% 50%, black 68%, transparent 92%);" />
