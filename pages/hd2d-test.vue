...
<template>
  <div style="min-height:100vh;background:#0b0818;color:#e8e2f5;display:flex;flex-direction:column;align-items:center;gap:12px;padding:14px;">
    ...
    >{{ portrait ? '📱 Verticale (mobile 9:16)' : '🖥 Orizzontale (PC 16:9)' }} — cambia</button>

    <div :style="frameStyle + 'border-radius:18px;overflow:hidden;border:1px solid rgba(167,139,250,0.25);box-shadow:0 20px 60px rgba(0,0,0,0.55);'">
      <ClientOnly>
        <BattleScene3D
          ref="scene"
