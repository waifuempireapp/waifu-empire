...
// NFD: i file caricati da macOS hanno gli accenti decomposti (es. À = A+grave)
const img = (file) => `${IK}/${encodeURI(file.normalize('NFD'))}`
...
const MOVES = [
  ...
  { id:'frammenti-tempo', name:'Frammenti di Tempo', type:'arcana', damage:25, additionalEffectLabel:'+ Rallenta 2 turni',
    ...
    isUltimate:false, file:'FRAMMENTI DI TEMPO _ Arcana_2.png' },
  { id:'specchio-infranto', name:'Specchio Infranto', type:'arcana', damage:15, additionalEffectLabel:'+ Riflette 50% danno',
    ...
    isUltimate:false, file:'SPECCHIO INFRANTO _ Arcana_2.png' },
  { id:'eclissi-arcana', name:'Eclissi Arcana', type:'arcana', damage:110, additionalEffectLabel:'danno + Silenzio a tutti i nemici',
    ...
    isUltimate:true, file:'ECLISSI ARCANA _ Arcana_2.png' },
  { id:'sciame-spine', name:'Sciame di Spine', type:'natura', damage:45, additionalEffectLabel:'+ Avvelenamento 3 turni',
    ...
    isUltimate:false, file:'SCIAME DI SPINE _ Natura.png' },
  { id:'respiro-foresta', name:'Respiro della Foresta', type:'natura', damage:0, additionalEffectLabel:'Cura 40 HP + Rigenerazione',
    ...
    isUltimate:false, file:'RESPIRO DELLA FORESTA _ Natura_2.png' },
  { id:'morso-liana', name:'Morso di Liana', type:'natura', damage:50, additionalEffectLabel:'+ Trascina e Stordisce 1 turno',
    ...
    isUltimate:false, file:'MORSO DI LIANA _ Natura_2.png' },
  { id:'lama-rotante', name:'Lama Rotante', type:'ferro', damage:75, multiHit:{ hits:3, damagePerHit:25 }, additionalEffectLabel:'= 75 totale (multi-hit rotante)',
    ...
    isUltimate:false, file:'LAMA ROTANTE _ Ferro_2.png' },
  { id:'muro-acciaio', name:"Muro d'Acciaio", type:'ferro', damage:0, additionalEffectLabel:'+ Difesa +50% per 2 turni a tutta la squadra',
    ...
    isUltimate:false, file:"MURO D'ACCIAIO _ Ferro_2.png" },
  { id:'giudizio-ferro', name:'Giudizio di Ferro', type:'ferro', damage:180, additionalEffectLabel:'danno massiccio + ignora Difesa',
    ...
    isUltimate:true, file:'GIUDIZIO DI FERRO _ Ferro_2.png' },
  { id:'catene-spettrali', name:'Catene Spettrali', type:'abisso', damage:30, additionalEffectLabel:'+ Immobilizza 1 turno + rimuove 1 buff',
    ...
    isUltimate:false, file:'CATENE SPETTRALI _ Abisso_2.png' },
  { id:'eco-vuoto', name:'Eco del Vuoto', type:'abisso', damage:35, additionalEffectLabel:'+ Drena 20 HP a fine turno per 3 turni',
    ...
    isUltimate:false, file:'ECO DEL VUOTO _ Abisso.png' },
  { id:'notte-eterna', name:'Notte Eterna', type:'abisso', damage:70, additionalEffectLabel:'danno a tutti + Accecamento 2 turni',
    ...
    isUltimate:true, file:'NOTTE ETERNA _ Abisso_2.png' },
  { id:'lancia-infuocata', name:'Lancia Infuocata', type:'fuoco', damage:75, additionalEffectLabel:'+ Perfora Scudi',
    ...
    isUltimate:false, file:'LANCIA INFUOCATA _ Fuoco.png' },
  { id:'cenere-vivente', name:'Cenere Vivente', type:'fuoco', damage:30, additionalEffectLabel:'+ Bruciatura propagante 3 turni',
    ...
    isUltimate:false, file:'CENERE VIVENTE _ Fuoco.png' },
  { id:'frusta-magma', name:'Frusta di Magma', type:'fuoco', damage:60, additionalEffectLabel:'+ Riduce Velocità 30% per 2 turni',
    ...
    isUltimate:false, file:'FRUSTA DI MAGMA _ Fuoco_2.png' },
  ...
  { id:'rune-fulminanti', name:'Rune Fulminanti', type:'arcana', damage:60, pp:10, additionalEffectLabel:'+ Stordisce 25%',
    ...
    isUltimate:false, file:'RUNE FULMINANTI _ Arcana.png' },
  { id:'luce-sorgiva', name:'Luce Sorgiva', type:'arcana', damage:0, pp:15, additionalEffectLabel:'+ Cura 50 HP squadra + Magia +30%',
    ...
    isUltimate:false, file:'LUCE SORGIVA _ Arcana_2.png' },
  { id:'lama-eterea', name:'Lama Eterea', type:'arcana', damage:80, pp:10, additionalEffectLabel:'+ Ignora 40% Difesa',
    ...
    isUltimate:false, file:'LAMA ETEREA _ Arcana_2.png' },
  { id:'tempesta-stelle', name:'Tempesta di Stelle', type:'arcana', damage:140, pp:5, additionalEffectLabel:'danno distribuito su tutti i nemici',
    ...
    isUltimate:true, file:'TEMPESTA DI STELLE _ Arcana_2.png' },
  { id:'nube-tossica', name:'Nube Tossica', type:'natura', damage:20, pp:15, additionalEffectLabel:'+ Veleno Potente su tutti i nemici',
    ...
    isUltimate:false, file:'NUBE TOSSICA _ Natura.png' },
  { id:'fulmine-verde', name:'Fulmine Verde', type:'natura', damage:95, pp:8, additionalEffectLabel:'+ Critico 35% + Paralisi 50%',
    ...
    isUltimate:false, file:'FULMINE VERDE _ Natura_2.png' },
  { id:'geyser-vita', name:'Geyser di Vita', type:'natura', damage:0, pp:15, additionalEffectLabel:'+ Cura 60 HP + Rigenerazione Intensa',
    ...
    isUltimate:false, file:'GEYSER DI VITA _ Natura_2.png' },
  { id:'fauci-terra', name:'Fauci della Terra', type:'natura', damage:100, pp:8, additionalEffectLabel:'+ Intrappola 2 turni + Critico elevato',
    ...
    isUltimate:false, file:'FAUCI DELLA TERRA _ Natura_2.png' },
  { id:'schegge-titanio', name:'Schegge di Titanio', type:'ferro', damage:100, pp:8, multiHit:{ hits:5, damagePerHit:20 }, additionalEffectLabel:'20 × 5 = 100 (multi-hit) + Difesa -5% per colpo',
    ...
    isUltimate:false, file:'SCHEGGE DI TITANIO _ Ferro_2.png' },
  { id:'colpo-gravita', name:'Colpo di Gravità', type:'ferro', damage:70, pp:10, additionalEffectLabel:'+ Azzera buff Velocità e Difesa nemico',
    ...
    isUltimate:false, file:'COLPO DI GRAVITÀ _ Ferro.png' },
  { id:'campo-magnetico', name:'Campo Magnetico', type:'ferro', damage:85, pp:10, additionalEffectLabel:"+ 20% di far cadere un equipaggiamento",
    ...
    isUltimate:false, file:'CAMPO MAGNETICO _ Ferro.png' },
  { id:'lancio-orbitale', name:'Lancio Orbitale', type:'ferro', damage:155, pp:5, additionalEffectLabel:'danno massiccio + ignora Scudi e Armature',
    ...
    isUltimate:true, file:'LANCIO ORBITALE _ Ferro.png' },
  { id:'maledizione-sangue', name:'Maledizione di Sangue', type:'abisso', damage:45, pp:12, additionalEffectLabel:'+ Maledizione Sanguinosa 4 turni',
    ...
    isUltimate:false, file:'MALEDIZIONE DI SANGUE _ Abisso_2.png' },
  { id:'doppelganger-oscuro', name:'Doppelganger Oscuro', type:'abisso', damage:65, pp:10, additionalEffectLabel:'+ Clone oscuro 1 turno + Precisione -20%',
    ...
    isUltimate:false, file:'DOPPELGANGER OSCURO _ Abisso_2.png' },
  { id:'risucchio-vitale', name:'Risucchio Vitale', type:'abisso', damage:55, pp:10, additionalEffectLabel:'+ Lifesteal 100% su questa mossa',
    ...
    isUltimate:false, file:'RISUCCHIO VITALE _ Abisso.png' },
  { id:'disintegrazione', name:'Disintegrazione', type:'abisso', damage:160, pp:5, additionalEffectLabel:'bypassa tutto + 10% KO istantaneo',
    ...
    isUltimate:true, file:'DISINTEGRAZIONE _ Abisso.png' },
  { id:'meteora', name:'Meteora', type:'fuoco', damage:85, pp:8, additionalEffectLabel:'+ danno ad area + Bruciatura a tutti i colpiti',
    ...
    isUltimate:false, file:'METEORA _ Fuoco_2.png' },
  { id:'supernova', name:'Supernova', type:'fuoco', damage:175, pp:5, additionalEffectLabel:'danno a tutti i nemici — solo sotto 50% HP',
    ...
    isUltimate:true, file:'SUPERNOVA _ Fuoco.png' },
  { id:'esplosione-sonica', name:'Esplosione Sonica', type:'fuoco', damage:80, pp:8, additionalEffectLabel:'+ Rimuove tutti gli Scudi nemici in campo',
    ...
    isUltimate:false, file:'ESPLOSIONE SONICA _ Fuoco_2.png' },
  { id:'artiglio-sole', name:'Artiglio del Sole', type:'fuoco', damage:90, pp:8, additionalEffectLabel:'+ Bruciatura Solare 2 turni',
    ...
    isUltimate:false, file:'ARTIGLIO DEL SOLE _ Fuoco.png' },
]
...
async function main() {
  ...
  for (const m of MOVES) {
    ...
    const doc = {
      ...
      rarita: d.rarita,
      pp: m.pp ?? d.pp,             // usa i PP forniti, altrimenti derivati
